...
function Login() {
  return (
    <>
      <main id="loginPage" className="background d-flex min-vh-100 justify-content-center align-items-center" style={{ backgroundColor: "#FFD365" }}>
            ...
            <div className="col-12 col-lg-10 col-xl-8 shadow rounded-6">
              <div className="form row justify-content-center py-md-0 py-5" style={{ backgroundColor: "white" }}>
                <div className="text-center d-md-none">
                  <h4>
                    Every New Knowledge is <span>a New Adventure</span>
                  </h4>
                  ...
                  <form id="loginForm">
                    <div className="mb-3">
                      ...
                      <div className="input-group mb-1">
                        ...
                        <input type="email" className="form-control" placeholder="Enter your e-mail" id="email" autoComplete="off" />
                      </div>
                      <small className="text-danger d-none">Please enter a valid email address</small>{" "}
                    </div>
                    <div className="mb-2">
                      ...
                      <div className="input-group mb-1">
                        ...
                        <input type="password" className="form-control" placeholder="Enter your password" id="password" autoComplete="off" />
                      </div>
